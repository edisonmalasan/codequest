...
Status: documentation draft. Meaningful rewards, repeat protection, derived levels and meaningful streaks are confirmed C01/C09. Concrete qualifying/replay/hint/date/unlock policies P09/P10/P14/P15 remain proposed in the [register](decisions.md). [Product](product.md) owns scope/glossary; [backend](backend.md) owns accepted effects; [curriculum](curriculum.md) owns instructional prerequisites.
