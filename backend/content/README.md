...
This is the Git-owned, backend-local source of curriculum. It is **not published** by adding files here. The current JavaScript Foundations tree contains one **draft** Q01 fixture to exercise the authoring contract. Phase 10 must separately define projection, activation, API delivery, and acceptance behavior. Do not import these files into the frontend or query application tables from the frontend.
